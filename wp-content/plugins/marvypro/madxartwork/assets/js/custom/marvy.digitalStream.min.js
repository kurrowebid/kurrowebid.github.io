(function( $ ) {
    ...
    var VisualDigitalStreamAnimation = {
        initDigitalStream: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualDigitalStreamAnimation.initDigitalStreamWidget);
        },
    ...
    $( window ).on('madxartwork/frontend/init', VisualDigitalStreamAnimation.initDigitalStream);
})( jQuery );