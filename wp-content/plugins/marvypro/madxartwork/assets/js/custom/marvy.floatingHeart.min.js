(function( $ ) {
    ...
    var VisualFloatingHeartAnimation = {
        initFloatingHeart: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualFloatingHeartAnimation.initFloatingHeartWidget);
        },
    ...
    function floatingHeartAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var flotingHeartZindex = document.querySelector('.marvy-custom-floating-heart-animation-section-'+sectionId+' .madxartwork-container');
    ...
    $( window ).on('madxartwork/frontend/init', VisualFloatingHeartAnimation.initFloatingHeart);
})( jQuery );
