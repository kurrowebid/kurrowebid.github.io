(function( $ ) {
    ...
    var VisualBirdsAnimation = {
        initBirds: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualBirdsAnimation.initBirdsWidget);
        },
    ...
    function birdsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var birdsZindex = document.querySelector('.marvy-custom-birds-animation-section-'+sectionId+' .madxartwork-container');
    ...
    $( window ).on('madxartwork/frontend/init', VisualBirdsAnimation.initBirds);
})( jQuery );