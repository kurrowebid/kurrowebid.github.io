(function( $ ) {
    ...
    var VisualFogAnimation = {
        initFog: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualFogAnimation.initFogWidget);
        },
    ...
    function fogAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var fogZindex = document.querySelector('.marvy-custom-fog-animation-section-'+sectionId+' .madxartwork-container');
            fogZindex.style.zIndex = '99';

            // Set min height
            var fogMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            fogMinHeight.closest('.madxartwork-top-section').style.minHeight = "100px";
    ...
    $( window ).on('madxartwork/frontend/init', VisualFogAnimation.initFog);
})( jQuery );