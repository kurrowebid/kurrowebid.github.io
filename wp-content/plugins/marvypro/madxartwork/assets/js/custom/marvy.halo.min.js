(function( $ ) {
    ...
    var VisualHaloAnimation = {
        initHalo: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualHaloAnimation.initHaloWidget);
        },
    ...
    function haloAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var haloZindex = document.querySelector('.marvy-custom-halo-animation-section-'+sectionId+' .madxartwork-container');
            haloZindex.style.zIndex = '99';

            // Set min height
            var haloMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            haloMinHeight.closest('.madxartwork-top-section').style.minHeight = "100px";
    ...
    $( window ).on('madxartwork/frontend/init', VisualHaloAnimation.initHalo);
})( jQuery );