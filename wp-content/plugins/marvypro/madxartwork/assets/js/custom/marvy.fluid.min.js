(function ($) {
    ...
    var VisualFluidAnimation = {
        initFluid: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualFluidAnimation.initFluidWidget);
        },
        initFluidWidget: function ($scope) {
            ...
            if (window.isEditMode || window.madxartworkFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    settings.desktop_click = fluidAnimationArgs.marvy_fluid_animation_desktop_click;
                    settings.mobile_click = fluidAnimationArgs.marvy_fluid_animation_mobile_click;
                    settings.random_splash = fluidAnimationArgs.marvy_fluid_animation_random_splash;
                    settings.random_splash_interval = fluidAnimationArgs.marvy_fluid_animation_random_splash_interval;
                    ...
                    settings.boomButtonIds = fluidAnimationArgs.marvy_fluid_boom_on_ids;
                });
                ...
                settings.desktop_click = $scope.data("marvy_fluid_animation_desktop_click");
                settings.mobile_click = $scope.data("marvy_fluid_animation_mobile_click");
                settings.random_splash = $scope.data("marvy_fluid_animation_random_splash");
                settings.random_splash_interval = $scope.data("marvy_fluid_animation_random_splash_interval");
                ...
                settings.boomButtonIds = $scope.data("marvy_fluid_boom_on_ids");
            }
    ...
    function fluidAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var fluidZindex = document.querySelector('.marvy-custom-fluid-animation-section-' + sectionId + ' .madxartwork-container');
            fluidZindex.style.zIndex = '1';

            var fluidPosition = document.querySelector('.madxartwork-element-' + sectionId + ' > canvas ');
            ...
            var boomButtons = settings.boomButtonIds != '' ? settings.boomButtonIds.toString().split(',') : [];
            var boomButtonIds = [];
            boomButtons.forEach((val) => {
                boomButtonIds.push(val.trim());
            });
...
`);
            ...
            if (settings.random_splash && isMobile()) {
                setTimeout(() => {
                    random_splash_interval();
                }, parseInt(settings.random_splash_interval) * 1000);
            }

            function random_splash_interval() {
                multipleSplats(Math.max(parseInt(Math.random() * 20) + 5,10));
                setTimeout(() => {
                    random_splash_interval();
                }, parseInt(settings.random_splash_interval) * 1000);
            }
            ...
            if(boomButtonIds.length > 0) {
                boomButtonIds.forEach(val => {
                    if(!(val == '' || val == undefined) && document.getElementById(val)) {
            ...
            if (settings.mobile_click) {
                ...
                document.querySelector('.marvy-custom-fluid-animation-section-' + sectionId).addEventListener('touchstart', e => {
                    ...
                    for (let i = 0; i < touches.length; i++) {
                        ...
                        pointer.deltaX = 0;
                        pointer.deltaY = 0;
                        pointer.color = (settings.colorful) ? generateColor() : hexToRgb(settings.single_color);
                    }
                });
    ...
    $(window).on('madxartwork/frontend/init', VisualFluidAnimation.initFluid);
})(jQuery);
