(function( $ ) {
    ...
    var VisualCellsAnimation = {
        initCells: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualCellsAnimation.initCellsWidget);
        },
    ...
    function cellsAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var cellsZindex = document.querySelector('.marvy-custom-cells-animation-section-'+sectionId+' .madxartwork-container');
    ...
    $( window ).on('madxartwork/frontend/init', VisualCellsAnimation.initCells);
})( jQuery );