(function( $ ) {
    ...
    var VisualNetAnimation = {
        initNet: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualNetAnimation.initNetWidget);
        },
    ...
    function netAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var netZindex = document.querySelector('.marvy-custom-net-animation-section-'+sectionId+' .madxartwork-container');
            netZindex.style.zIndex = '99';

            // Set min height
            var netMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            netMinHeight.closest('.madxartwork-top-section').style.minHeight = "100px";
    ...
    $( window ).on('madxartwork/frontend/init', VisualNetAnimation.initNet);
})( jQuery );