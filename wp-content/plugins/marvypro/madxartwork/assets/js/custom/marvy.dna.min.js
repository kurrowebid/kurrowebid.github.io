(function ($) {
    ...
    var VisualDNAAnimation = {
        initDNA: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualDNAAnimation.initDNAWidget);
        },
    ...
    function dnaAnimation(target, settings, sectionId) {
        ...
        if (checkElement.length >= 0 && settings) {
            ...
            var dnaZindex = document.querySelector('.marvy-custom-dna-animation-section-' + sectionId + ' .madxartwork-container');
  ...
  `
    ...
    $(window).on('madxartwork/frontend/init', VisualDNAAnimation.initDNA);
})(jQuery);
