(function( $ ) {
    ...
    var VisualTrunkAnimation = {
        initTrunk: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualTrunkAnimation.initTrunkWidget);
        },
    ...
    function trunkAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var trunkZindex = document.querySelector('.marvy-custom-trunk-animation-section-'+sectionId+' .madxartwork-container');
            trunkZindex.style.zIndex = '99';

            // Set min height
            var trunkMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            trunkMinHeight.closest('.madxartwork-top-section').style.minHeight = "200px";
    ...
    $( window ).on('madxartwork/frontend/init', VisualTrunkAnimation.initTrunk);
})( jQuery );