(function ($) {
    ...
    var MarvyColorSnowAnimation = {
        initColorSnow: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', MarvyColorSnowAnimation.initColorSnowWidget);
        },
        initColorSnowWidget: function ($scope) {
            ...
            if (window.isEditMode || window.madxartworkFrontend.isEditMode()) {
                ...
                colorSnowEditorElements = window.madxartwork.elements;
    ...
    $(window).on('madxartwork/frontend/init', MarvyColorSnowAnimation.initColorSnow);
    ...
    function colorSnowAnimation(target, settings, sectionId, sectionKey) {
        ...
        if (checkElement.length <= 0) {
            ...
            var zIndex = document.querySelector('.marvy-custom-snow-section-' + sectionId + ' .madxartwork-container');
