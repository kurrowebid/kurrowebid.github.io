(function( $ ) {
    ...
    var VisualGradientBackgroundAnimation = {
        initGradientBackground: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualGradientBackgroundAnimation.initGradientBackgroundWidget);
        },
    ...
    function gradientBackgroundAnimation(target, settings, sectionId, sectionKey) {
        ...
        if (checkElement.length >= 0) {
            ...
            var gradientBackgroundZindex = document.querySelector('.marvy-custom-gradientBackground-animation-section-'+sectionId+' .madxartwork-container');
    ...
    $( window ).on('madxartwork/frontend/init', VisualGradientBackgroundAnimation.initGradientBackground);
})( jQuery );
