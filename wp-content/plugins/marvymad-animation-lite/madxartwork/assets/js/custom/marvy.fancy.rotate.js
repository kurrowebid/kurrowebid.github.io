(function( $ ) {
    ...
    var MarvyBannerAnimation = {
        initBanner: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', MarvyBannerAnimation.initBannerWidget);
        },
    ...
    $( window ).on('madxartwork/frontend/init', MarvyBannerAnimation.initBanner);
    ...
    function bannerAnimation(target,settings,sectionId, sectionKey) {
        ...
        if (checkElement.length >= 0 ) {
            ...
            var bannerZindex = document.querySelector('.marvy-custom-banner-animation-section-'+sectionId+' .madxartwork-container');
            bannerZindex.style.zIndex = '99';

            var bannerMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            bannerMinHeight.closest('.madxartwork-top-section').style.minHeight = "200px";
