(function( $ ) {
    ...
    var VisualWavesAnimation = {
        initWaves: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', VisualWavesAnimation.initWavesWidget);
        },
    ...
    function wavesAnimation(target,settings,sectionId) {
        ...
        if (checkElement.length >= 0) {
            ...
            var wavesZindex = document.querySelector('.marvy-custom-waves-animation-section-'+sectionId+' .madxartwork-container');
            wavesZindex.style.zIndex = '99';

            // Set min height
            var wavesMinHeight = document.querySelector(".madxartwork-element-"+sectionId);
            wavesMinHeight.closest('.madxartwork-top-section').style.minHeight = "200px";
    ...
    $( window ).on('madxartwork/frontend/init', VisualWavesAnimation.initWaves);
})( jQuery );
