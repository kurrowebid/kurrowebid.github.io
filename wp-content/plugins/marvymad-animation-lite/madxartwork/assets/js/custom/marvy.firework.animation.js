(function ($) {
    ...
    var MarvyFireworkAnimation = {
        initFirework: function () {
            madxartworkFrontend.hooks.addAction('frontend/element_ready/section', MarvyFireworkAnimation.initFireworkWidget);
        },
        ...
        loadFireworks: function (target, sectionId, settings) {
            ...
            if (checkElement.length >= 0) {
                ...
                const fireworkZindex = document.querySelector('.marvy-custom-firework-animation-section-' + sectionId + ' .madxartwork-container');
                fireworkZindex.style.zIndex = '99';

                // Set min height
                const fireworkMinHeight = document.querySelector(".madxartwork-element-" + sectionId);
                fireworkMinHeight.closest('.madxartwork-top-section').style.minHeight = "100px";
                // Canvas Setup End
    ...
    $(window).on('madxartwork/frontend/init', MarvyFireworkAnimation.initFirework);
