(function ($, madxartwork) {
    ...
    jQuery(window).on('madxartwork/frontend/init', function () {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-isolate.default', widgetIsolate);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-isolate.locate', widgetIsolate);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-isolate.slice', widgetIsolate);
    });
