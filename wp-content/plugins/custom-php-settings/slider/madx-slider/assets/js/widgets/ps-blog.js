(function ($, madxartwork) {
    ...
    jQuery(window).on('madxartwork/frontend/init', function () {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-blog.default', widgetBlog);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-blog.coral', widgetBlog);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-blog.folio', widgetBlog);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-blog.zinest', widgetBlog);
    });
