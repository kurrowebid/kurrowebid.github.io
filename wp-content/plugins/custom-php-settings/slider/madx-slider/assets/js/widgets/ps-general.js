(function($, madxartwork) {
    ...
    jQuery(window).on('madxartwork/frontend/init', function() {
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-general.default', widgetGeneral);
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-general.slide', widgetGeneral); 
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-general.crelly', widgetGeneral); 
        madxartworkFrontend.hooks.addAction('frontend/element_ready/prime-slider-general.meteor', widgetGeneral); 
    });
