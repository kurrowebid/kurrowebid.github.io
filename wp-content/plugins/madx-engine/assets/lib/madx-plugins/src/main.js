...
class madxPlugins {
	...
	isBlockRequiresInit( el ) {
		...
		// need do it again
		let needInit    = undefined === el.dataset.madxInited;
...
window.madxPlugins = window.madxPlugins || new madxPlugins();