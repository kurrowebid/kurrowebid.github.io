(function( $ ) {
	 ...
	 * Base Analysis class.
	 */
	class madxEngineSeoAnalysisBase {
		...
		setup() {
			this.pluginName = 'madx-engine-seo-analysis';
			this.fields = {
				title: [],
				content: window.madxEngineSeoConfig.fields,
			};
	 ...
	 */
	class madxEngineRankMathAnalysis extends madxEngineSeoAnalysisBase {
		hooks() {
	 ...
	 */
	class madxEngineYoastAnalysis extends madxEngineSeoAnalysisBase {
	...
	$( function () {
		...
		if ( window.madxEngineSeoConfig.isRankMathActived && 'undefined' !== typeof rankMathEditor ) {
			new madxEngineRankMathAnalysis();
		}

		if ( window.madxEngineSeoConfig.isYoastActived && 'undefined' !== typeof YoastSEO && typeof 'undefined' !== YoastSEO.app ) {
			new madxEngineYoastAnalysis();
		}
	} );
