Vue.component( 'madx-engine-shortcode-generator', {
	name: 'madx-engine-shortcode-generator',
	template: '#madx-engine-shortcode-generator',
	data: function() {
		return {
			sources: window.madxEngineDashboardConfig.shortode_generator.sources,
			objectFields: window.madxEngineDashboardConfig.shortode_generator.object_fields,
			sourceArgs: window.madxEngineDashboardConfig.shortode_generator.source_args,
			metaFields: window.madxEngineDashboardConfig.shortode_generator.meta_fields,
			optionsPages: window.madxEngineDashboardConfig.shortode_generator.options_pages,
			callbacks: window.madxEngineDashboardConfig.shortode_generator.callbacks,
			cbArgs: window.madxEngineDashboardConfig.shortode_generator.cb_args,
			contextList: window.madxEngineDashboardConfig.shortode_generator.context_list,
			labels: window.madxEngineDashboardConfig.shortode_generator.labels,
			shortcode: '[madx_engine_data ]',
			controls: {},
