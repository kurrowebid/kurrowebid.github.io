Vue.component( 'madx-engine-macros-generator', {
	name: 'madx-engine-macros-generator',
	template: '#madx-engine-macros-generator',
	data: function() {
		return {
			macrosData: window.madxEngineDashboardConfig.macros_generator,
