(function( $, exportConfig, presetsConfig ) {
	...
	Vue.component( 'madx-engine-skins-presets', {
		template: '#madx_engine_skins_presets',
		data: function() {
			return {
				isActive: false,
				loading: false,
		...
		methods: {
			importPreset: function( preset ) {
				...
				jQuery.ajax({
					...
					dataType: 'json',
					data: {
						action: 'madx_engine_import_preset',
						preset: self.currentPreset,
						_nonce: window.madxEngineDashboardConfig._nonce,
					},
				}).done(function() {
			...
			missDeps: function( preset ) {
				...
				if ( window.madxEngineDashboardConfig.active_modules && window.madxEngineDashboardConfig.active_modules.length ) {
					activeModules = window.madxEngineDashboardConfig.active_modules;
				}
			...
			getDeps: function( preset ) {
				...
				var presetData      = this.presets[preset],
					internalModules = window.madxEngineDashboardConfig.internal_modules,
					externalModules = window.madxEngineDashboardConfig.external_modules,
	...
	Vue.component( 'madx-engine-skin-export', {
		template: '#madx_engine_skin_export',
		data: function() {
			return {
				isActive: false,
	...
	Vue.component( 'madx-engine-skin-import', {
		template: '#madx_engine_skin_import',
		data: function() {
			return {
				isActive: false,
				isLoading: false,
		...
		methods: {
			...
			processImport: function() {
				...
				formData.append( 'action', 'madx_engine_import_skin' );
				formData.append( '_nonce', window.madxEngineDashboardConfig._nonce );
...
})( jQuery, window.madxEngineExportConfig, window.madxEnginePresetsConfig );
