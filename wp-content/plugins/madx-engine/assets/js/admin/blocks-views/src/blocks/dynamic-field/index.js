...
registerBlockType( 'madx-engine/dynamic-field', {
	title: __( 'Dynamic Field' ),
	icon: Icon,
	category: 'madx-engine',
	attributes: window.madxEngineListingData.atts.dynamicField,
	className: 'madx-listing-dynamic-field',
	usesContext: [ 'postId', 'postType', 'queryId' ],
	edit: function( props ) {

		const attributes          = props.attributes;
		const fieldSources        = window.madxEngineListingData.fieldSources;
		const glossaries          = window.madxEngineListingData.glossariesList;
		...
		const relTypes            = window.madxEngineListingData.relationsTypes;
		const postTypes           = window.madxEngineListingData.postTypes;
		const metaFields          = window.madxEngineListingData.metaFields;
		const optionsFields       = window.madxEngineListingData.optionsFields;
		const filterCallbacksArgs = window.madxEngineListingData.filterCallbacksArgs;
		const relationsMeta       = window.madxEngineListingData.relationsMeta;
		...
		var object = window.madxEngineListingData.object_id;
		var listing = window.madxEngineListingData.settings;
			...
			props.isSelected && (
					...
					>
						<PanelBody title={ __( 'General' ) }>
							...
							{ 'acf_field_groups' === attributes.dynamic_field_source && undefined !== window.madxEngineListingData.acfFields &&
								<GroupedSelectControl
									label={ __( 'ACF Field' ) }
									value={ attributes.acf_field_key }
									options={ window.madxEngineListingData.acfFields }
									onChange={ newValue => {
						...
						<PanelBody title={ __( 'Layout' ) }>
							{ ! window.madxEngineListingData.preventWrap && <RadioControl
