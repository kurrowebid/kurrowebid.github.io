...
var ImglinkFields = JSON.parse( JSON.stringify( window.madxEngineListingData.linkFields ) );
...
registerBlockType( 'madx-engine/dynamic-image', {
	title: __( 'Dynamic Image' ),
	icon: ImgIcon,
	category: 'madx-engine',
	attributes: window.madxEngineListingData.atts.dynamicImage,
	className: 'madx-listing-dynamic-image',
	...
	edit: class extends wp.element.Component {
		...
		render() {
			...
			const imageSizes         = window.madxEngineListingData.imageSizes;
			...
			const mediaOptionsFields = window.madxEngineListingData.mediaOptionsFields;
			const allowedContextList = window.madxEngineListingData.allowedContextList;
			const profilePages       = window.madxEngineListingData.profileBuilderPages;
			...
			return [
				props.isSelected && (
						...
						>
							<PanelBody title={ __( 'General' ) }>
								...
								{ 'acf_field_groups' === attributes.dynamic_image_source && undefined !== window.madxEngineListingData.acfImagesFields &&
									<GroupedSelectControl
										label={ __( 'ACF Field' ) }
										value={ attributes.acf_field_key }
										options={ window.madxEngineListingData.acfImagesFields }
										onChange={ newValue => {
							...
							<PanelBody title={ __( 'Layout' ) }>
								...
								{ ( attributes.linked_image && 'acf_field_groups' === attributes.image_link_source ) && undefined !== window.madxEngineListingData.acfLinksFields &&
									<GroupedSelectControl
										label={ __( 'ACF Field' ) }
										value={ attributes.acf_link_field_key }
										options={ window.madxEngineListingData.acfLinksFields }
										onChange={ newValue => {
				...
				<Disabled key={ 'block_render' }>
					<ServerSideRender
						block="madx-engine/dynamic-image"
