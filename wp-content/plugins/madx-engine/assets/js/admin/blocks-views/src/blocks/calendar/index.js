...
if ( -1 !== window.madxEngineListingData.activeModules.indexOf( 'calendar' ) ) {
	...
	const blockAttributes = window.madxEngineListingData.atts.listingCalendar;

	registerBlockType( 'madx-engine/listing-calendar', {
		title: __( 'Listing Calendar' ),
		icon: GIcon,
		category: 'madx-engine',
		attributes: blockAttributes,
		className: 'madx-listing-calendar',
			...
			render() {
				...
				return [
											...
											<div>
												...
												<div>
													<SelectControl
														...
														options={ window.madxEngineListingData.taxonomies }
														onChange={newValue => {
					...
					<Disabled key={ 'block_render' }>
						<ServerSideRender
							block="madx-engine/listing-calendar"
