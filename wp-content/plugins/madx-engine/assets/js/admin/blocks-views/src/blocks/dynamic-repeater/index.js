...
registerBlockType( 'madx-engine/dynamic-repeater', {
	title: __( 'Dynamic Repeater' ),
	icon: RIcon,
	category: 'madx-engine',
	attributes: window.madxEngineListingData.atts.dynamicRepeater,
	className: 'madx-listing-dynamic-repeater',
	...
	edit: class extends wp.element.Component {
		...
		render() {
			...
			const repeaterFields = window.madxEngineListingData.repeaterFields;
			const optionsFields  = window.madxEngineListingData.repeaterOptionsFields;
			...
			return [
				props.isSelected && (
					...
					>
						<PanelBody title={ __( 'General' ) }>
							...
							{ 'acf_field_groups' === attributes.dynamic_field_source && undefined !== window.madxEngineListingData.acfRepeaterFields &&
								<GroupedSelectControl
									label={ __( 'ACF Field' ) }
									value={ attributes.acf_field_key }
									options={ window.madxEngineListingData.acfRepeaterFields }
									onChange={ newValue => {
										props.setAttributes({
				...
				<Disabled key={ 'block_render' }>
					<ServerSideRender
						block="madx-engine/dynamic-repeater"
