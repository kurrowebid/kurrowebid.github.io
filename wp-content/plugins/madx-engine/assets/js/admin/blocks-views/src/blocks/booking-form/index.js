...
if ( -1 !== window.madxEngineListingData.activeModules.indexOf( 'booking-forms' ) ) {
	...
	const blockAttributes = window.madxEngineListingData.atts.bookingForm;

	registerBlockType( 'madx-engine/booking-form', {
		title: __( 'Form' ),
		icon: GIcon,
		...
		edit: class extends wp.element.Component {
			render() {
				...
				const formsOptions  = window.madxEngineListingData.formsOptions;
