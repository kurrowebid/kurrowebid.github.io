...
registerBlockType( 'madx-engine/dynamic-terms', {
	title: __( 'Dynamic Terms' ),
	icon: TRIcon,
	category: 'madx-engine',
	attributes:  window.madxEngineListingData.atts.dynamicTerms,
	className: 'madx-listing-dynamic-terms',
	...
	edit: class extends wp.element.Component {
		...
		render() {
			...
			const taxList            = window.madxEngineListingData.taxonomies;
			...
			return [
				...
				<Disabled key={ 'block_render' }>
					<ServerSideRender
						block="madx-engine/dynamic-terms"
