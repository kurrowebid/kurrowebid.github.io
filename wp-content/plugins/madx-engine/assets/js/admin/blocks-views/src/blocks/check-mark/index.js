...
if ( -1 !== window.madxEngineListingData.activeModules.indexOf( 'booking-forms' ) ) {
	...
	const blockAttributes = window.madxEngineListingData.atts.checkMark;

	registerBlockType( 'madx-engine/check-mark', {
		title: __( 'Check Mark' ),
		icon: GIcon,
		category: 'madx-engine',
		attributes: blockAttributes,
		className: 'madx-form__check-mark',
