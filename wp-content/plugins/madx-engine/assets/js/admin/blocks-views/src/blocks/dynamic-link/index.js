...
registerBlockType( 'madx-engine/dynamic-link', {
	title: __( 'Dynamic Link' ),
	icon: LIcon,
	category: 'madx-engine',
	attributes: window.madxEngineListingData.atts.dynamicLink,
	className: 'madx-listing-dynamic-link',
	...
	edit: class extends wp.element.Component {
		...
		render() {
			...
			const linkFields         = window.madxEngineListingData.linkFields;
			...
			const customComtrols     = window.madxEngineListingData.customControls['dynamic-link'];
			...
			return [
				props.isSelected && (
						...
						>
							<PanelBody title={ __( 'General' ) }>
								...
								{ 'acf_field_groups' === attributes.dynamic_link_source && undefined !== window.madxEngineListingData.acfLinksFields &&
									<GroupedSelectControl
										label={ __( 'ACF Field' ) }
								...
								{ ! window.madxEngineListingData.preventWrap && <SelectControl
				...
				<Disabled key={ 'block_render' }>
					<ServerSideRender
						block="madx-engine/dynamic-link"
