...
if ( -1 !== window.madxEngineListingData.activeModules.indexOf( 'maps-listings' ) ) {
	...
	const blockAttributes = window.madxEngineListingData.atts.mapsListing;

	registerBlockType( 'madx-engine/maps-listing', {
		title: __( 'Map Listing' ),
		icon: GIcon,
		category: 'madx-engine',
		attributes: blockAttributes,
		className: 'madx-map-listing',
		edit: class extends wp.element.Component {
			...
			getCustomControlsSection( section ) {
				...
				const providerControls = window.madxEngineListingData.mapsListingConfig.providerControls;
			...
			render() {
				...
				const metaFields          = window.madxEngineListingData.metaFields;
				const filterCallbacks     = window.madxEngineListingData.filterCallbacks;
				const markerTypes         = window.madxEngineListingData.mapsListingConfig.markerTypes;
				const markerLabelTypes    = window.madxEngineListingData.mapsListingConfig.markerLabelTypes;
				const filterCallbacksArgs = window.madxEngineListingData.filterCallbacksArgs;
					...
					props.isSelected && (
						...
						>
							...
							>
								...
								<div className="madx-media-control components-base-control">
								...
								/> }
								{ -1 !== window.madxEngineListingData.activeModules.indexOf( 'custom-content-types' ) &&
