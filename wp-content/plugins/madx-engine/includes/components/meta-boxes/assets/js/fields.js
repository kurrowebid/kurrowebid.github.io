Vue.component( 'madx-meta-field-options', {
	name: 'madx-meta-field-options',
	template: '#madx-meta-field-options',
	props: {
		value: {
			type: Array,
			default: function() {
...
Vue.component( 'madx-meta-field', {
	name: 'madx-meta-field',
	template: '#madx-meta-field',
	props: {
		value: {
			type: Object,
			default: function() {
	...
	data() {
		return {
			field: {},
			glossariesList: madxEngineFieldsConfig.glossaries,
			postTypes: madxEngineFieldsConfig.post_types,
			i18n: madxEngineFieldsConfig.i18n,
			quickEditSupports: madxEngineFieldsConfig.quick_edit_supports,
		};
	},
	created() {
	...
	methods: {
		...
		getFilteredFieldConditions: function( conditions, fieldOption ) {
			return window.madxPlugins.hooks.applyFilters( 
		...
		sanitizeFieldName: function() {
			...
			name = window.madxEngineTools.maybeCyrToLatin( name );
		...
		sanitizeRepeaterFieldName: function( repeaterFieldIndex ) {
			...
			repeaterField.name = window.madxEngineTools.maybeCyrToLatin( repeaterField.name );
...
Vue.component( 'madx-meta-fields', {
	name: 'madx-meta-fields',
	template: '#madx-meta-fields',
	props: {
		value: {
			type: Array,
			default: function() {
	...
	data: function() {
		return {
			...
			fieldTypes: madxEngineFieldsConfig.field_types,
			allowedFieldTypes: madxEngineFieldsConfig.allowed_types,
			postTypes: madxEngineFieldsConfig.post_types,
			blockTitle: madxEngineFieldsConfig.title,
			buttonLabel: madxEngineFieldsConfig.button,
			disabledFields: madxEngineFieldsConfig.disabled,
			i18n: madxEngineFieldsConfig.i18n,
