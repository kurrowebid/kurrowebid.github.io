Vue.component( 'madx-query-dynamic-args', {
	name: 'madx-query-dynamic-args',
	template: '#madx-query-dynamic-args',
	directives: { clickOutside: window.madxVueUIClickOutside },
	props: [ 'value' ],
	data: function() {
		return {
			isActive: false,
			macrosList: window.madxEngineQueryDynamicArgs.macros_list,
			contextList: window.madxEngineQueryDynamicArgs.context_list,
			currentMacros: {},
			editMacros: false,
			editSettings: false,
			result: {},
