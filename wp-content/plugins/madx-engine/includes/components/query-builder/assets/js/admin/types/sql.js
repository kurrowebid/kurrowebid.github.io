(function( $ ) {
	...
	Vue.component( 'madx-sql-query', {
		template: '#madx-sql-query',
		mixins: [
		...
		data: function() {
			return {
				tablesList: window.madx_query_component_sql.tables,
				castObjectsList: window.madx_query_component_sql.cast_objects,
		...
		methods: {
			...
			getColumns: function( table ) {
				return window.madx_query_component_sql.columns[ table ] || [];
			},
