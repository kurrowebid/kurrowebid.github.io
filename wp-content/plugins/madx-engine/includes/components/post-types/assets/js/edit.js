(function( $, madxEngineCPTConfig ) {
	...
	Vue.component( 'madx-engine-admin-filters', {
		name: 'madx-engine-admin-filters',
		template: '#madx-engine-admin-filters',
		props: [ 'value', 'metaFields', 'postType' ],
		data() {
			return {
				adminFilters: [],
				adminFiltersTypes: madxEngineCPTConfig.admin_filters_types,
				taxonomies: madxEngineCPTConfig.taxonomies_full_data,
				allFields: madxEngineCPTConfig.all_fields,
				glossariesList: madxEngineCPTConfig.glossaries_list
			};
		},
		created() {
	...
	window.madxEngineCPT = new Vue( {
		...
		data: {
			...
			adminColumns: madxEngineCPTConfig.admin_columns,
			adminColumnsTypes: madxEngineCPTConfig.columns_types,
			adminFilters: [],
			icons: madxEngineCPTConfig.icons,
			supports: madxEngineCPTConfig.supports,
			...
			availablePositions: madxEngineCPTConfig.positions,
			defaultMenuPosition: madxEngineCPTConfig.default_position,
			positionIDs: [],
			...
			callbacks: {
				list: madxEngineCPTConfig.admin_columns_cb,
				showPopup: false,
				currentArgs: false,
				activeColumn: false,
				current: false,
