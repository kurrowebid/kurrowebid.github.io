	...
	render() {
		return <PanelBody 
			...
			<TextareaControl
				...
				value={ this.props.attributes.madx_rest_query }
				onChange={ newValue => {
					this.handleChange( 'madx_rest_query', newValue );
				} }
			/>
		</PanelBody>;
	}
...
window.madxEngineListingData.customPanles.listingGrid.push( RestPanel );
