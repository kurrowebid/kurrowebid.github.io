const madxMapboxPopup = function( data ) {
...
window.madxEngineMapsProvider = function() {
	...
	this.initMap = function( container, settings ) {
		...
		mapboxgl.accessToken = window.madxEngineMapboxData.token;
	...
	this.getMarkerCluster = function( data ) {
		return new madxMapboxMarkerClusterer( data );
	}
