function madxGMInfoBox(opt_opts) {
	...
	// Additional options (unique to madxGMInfoBox):
...
/* madxGMInfoBox extends OverlayView in the Google Maps API v3.
 */
madxGMInfoBox.prototype = new google.maps.OverlayView();

madxGMInfoBox.prototype.addEventListener = function ( target, type, handler, useCapture ) {
...
madxGMInfoBox.prototype.removeEventListener = function ( listener ) {
	listener.target.removeEventListener( listener.type, listener.handler, listener.useCapture );
}

/**
 * Creates the DIV representing the madxGMInfoBox.
 * @private
 */
madxGMInfoBox.prototype.createmadxGMInfoBoxDiv_ = function () {
	...
	// This handler prevents an event in the madxGMInfoBox from being passed on to the map.
	//
	var cancelHandler = function (e) {
		var hasListingOverlay = 'click' === e.type && e.currentTarget.querySelector('.madx-engine-listing-overlay-wrap');
	...
	// This handler ignores the current event in the madxGMInfoBox and conditionally prevents
	...
	if (!this.div_) {
		...
		// Add the madxGMInfoBox DIV to the DOM
		...
		if (!this.enableEventPropagation_) {
			...
			// when the mouse moves over a marker underneath madxGMInfoBox.
		...
		/**
		 * This event is fired when the DIV containing the madxGMInfoBox's content is attached to the DOM.
		 * @name madxGMInfoBox#domready
		 * @event
		 */
 ...
 * @private
 */
madxGMInfoBox.prototype.getCloseBoxImg_ = function () {
...
/**
 * Adds the click handler to the madxGMInfoBox close box.
 * @private
 */
madxGMInfoBox.prototype.addClickHandler_ = function () {
...
/**
 * Returns the function to call when the user clicks the close box of an madxGMInfoBox.
 * @private
 */
madxGMInfoBox.prototype.getCloseClickHandler_ = function () {
	...
	return function (e) {
		...
		/**
		 * This event is fired when the madxGMInfoBox's close box is clicked.
		 * @name madxGMInfoBox#closeclick
		 * @event
		 */
...
/**
 * Pans the map so that the madxGMInfoBox appears entirely within the map's visible area.
 * @private
 */
madxGMInfoBox.prototype.panBox_ = function (disablePan) {
...
/**
 * Sets the style of the madxGMInfoBox by setting the style sheet and applying
 * other specific styles requested.
 * @private
 */
madxGMInfoBox.prototype.setBoxStyle_ = function () {
	...
	if (this.div_) {
		...
		// Fix for iOS disappearing madxGMInfoBox problem.
...
/**
 * Get the widths of the borders of the madxGMInfoBox.
 * @private
 * @return {Object} widths object (top, bottom left, right)
 */
madxGMInfoBox.prototype.getBoxWidths_ = function () {
 ...
 */
madxGMInfoBox.prototype.onRemove = function () {
...
/**
 * Draws the madxGMInfoBox based on the current map projection and zoom level.
 */
madxGMInfoBox.prototype.draw = function () {

	this.createmadxGMInfoBoxDiv_();
...
/**
 * Sets the options for the madxGMInfoBox. Note that changes to the <tt>maxWidth</tt>,
 *  <tt>closeBoxMargin</tt>, <tt>closeBoxTitle</tt>, <tt>closeBoxURL</tt>, and
 *  <tt>enableEventPropagation</tt> properties have no affect until the current
 *  madxGMInfoBox is <tt>close</tt>d and a new one is <tt>open</tt>ed.
 * @param {madxGMInfoBoxOptions} opt_opts
 */
madxGMInfoBox.prototype.setOptions = function (opt_opts) {
...
madxGMInfoBox.prototype.contentIsSet = function () {
	return "" !== this.content_;
};

/**
 * Sets the content of the madxGMInfoBox.
 *  The content can be plain text or an HTML DOM node.
 * @param {string|Node} content
 */
madxGMInfoBox.prototype.setContent = function (content) {
	...
	/**
	 * This event is fired when the content of the madxGMInfoBox changes.
	 * @name madxGMInfoBox#content_changed
	 * @event
	 */
...
/**
 * Sets the geographic location of the madxGMInfoBox.
 * @param {LatLng} latlng
 */
madxGMInfoBox.prototype.setPosition = function (latlng) {
	...
	/**
	 * This event is fired when the position of the madxGMInfoBox changes.
	 * @name madxGMInfoBox#position_changed
	 * @event
	 */
...
/**
 * Sets the zIndex style for the madxGMInfoBox.
 * @param {number} index
 */
madxGMInfoBox.prototype.setZIndex = function (index) {
	...
	/**
	 * This event is fired when the zIndex of the madxGMInfoBox changes.
	 * @name madxGMInfoBox#zindex_changed
	 * @event
	 */
...
/**
 * Sets the visibility of the madxGMInfoBox.
 * @param {boolean} isVisible
 */
madxGMInfoBox.prototype.setVisible = function (isVisible) {
...
/**
 * Returns the content of the madxGMInfoBox.
 * @returns {string}
 */
madxGMInfoBox.prototype.getContent = function () {

	return this.content_;
};

/**
 * Returns the geographic location of the madxGMInfoBox.
 * @returns {LatLng}
 */
madxGMInfoBox.prototype.getPosition = function () {

	return this.position_;
};

/**
 * Returns the zIndex for the madxGMInfoBox.
 * @returns {number}
 */
madxGMInfoBox.prototype.getZIndex = function () {

	return this.zIndex_;
};

/**
 * Returns a flag indicating whether the madxGMInfoBox is visible.
 * @returns {boolean}
 */
madxGMInfoBox.prototype.getVisible = function () {
...
/**
 * Returns the width of the madxGMInfoBox in pixels.
 * @returns {number}
 */
madxGMInfoBox.prototype.getWidth = function () {
	var width = null;
...
/**
 * Returns the height of the madxGMInfoBox in pixels.
 * @returns {number}
 */
madxGMInfoBox.prototype.getHeight = function () {
	var height = null;
...
/**
 * Shows the madxGMInfoBox. [Deprecated; use <tt>setVisible</tt> instead.]
 */
madxGMInfoBox.prototype.show = function () {
...
/**
 * Hides the madxGMInfoBox. [Deprecated; use <tt>setVisible</tt> instead.]
 */
madxGMInfoBox.prototype.hide = function () {
...
/**
 * Adds the madxGMInfoBox to the specified map or Street View panorama. If <tt>anchor</tt>
 *  (usually a <tt>google.maps.Marker</tt>) is specified, the position
 *  of the madxGMInfoBox is set to the position of the <tt>anchor</tt>. If the
 *  anchor is dragged to a new location, the madxGMInfoBox moves as well.
 * @param {Map|StreetViewPanorama} map
 * @param {MVCObject} [anchor]
 */
madxGMInfoBox.prototype.open = function (map, anchor) {
...
/**
 * Removes the madxGMInfoBox from the map.
 */
madxGMInfoBox.prototype.close = function () {
