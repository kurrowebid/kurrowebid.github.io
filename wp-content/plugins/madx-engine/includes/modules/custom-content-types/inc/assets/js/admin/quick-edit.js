( function( $ ) {
	...
	class madxEngineQuickEdit {
		...
		constructor() {
			...
			this.$template = document.getElementById( 'madx_engine_cct_quick_edit_template' );

			$( document ).on( 'click.madxEngineQuickEdit', '.madx-engine-cct-quick-edit', ( event ) => {
			...
			$( document ).on( 'click.madxEngineQuickEdit', '.madx-engine-cct-quick-edit--cancel', ( event ) => {
				this.cancelEdit();
			} );

			$( document ).on( 'click.madxEngineQuickEdit', '.madx-engine-cct-quick-edit--save', ( event ) => {
