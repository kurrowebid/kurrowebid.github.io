...
registerBlockType( 'madx-engine/data-store-button', {
	title: __( 'Data Store Button' ),
	icon: Icon,
	category: 'madx-engine',
	attributes: window.madxEngineListingData.atts.dataStoreButton,
	className: 'madx-data-store-link-wrapper',
	edit: function( props ) {

		const attributes    = props.attributes;
		const storesOptions = window.madxEngineListingData.dataStores;
		...
		return [
			...
			<Disabled key={ 'block_render' }>
				<ServerSideRender
					block="madx-engine/data-store-button"
